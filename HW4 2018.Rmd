...
When using the `paste0` function instead of the `paste` function, there are no spaces placed between these strings of text when they are joined.  
...
Write the R code below to merge these 4 strings.
...
mySeparatedNewString <- str_split(myNewString, "_")
mySeparatedNewString
...
On another occasion, I need the same string split so that the first word comes off, and the rest remains intact. I can achieve that in the following way:
...
myNewString <- "Now_is_the_time_for_all_good_men_to_come_to_the_aid_of_their_country"
myNewSplitSpring2 <- str_split(myNewString, "_", n=2)
myNewSplitSpring2
...
pun <- "A statistician can have his head in an oven and his feet in ice, and he will say that on the average he feels fine"
punModified2 <- stri_replace_all_fixed(pun, c("he", "his"), c("she", "her"), vectorize_all = FALSE)
punModified2
...
pun <- "A statistician can have his head in an oven and his feet in ice, and he will say that on the average he feels fine"
punModified3 <- stri_replace_all_fixed(pun, c(" he ", " his "), c(" she ", " her "), vectorize_all = FALSE)
punModified3

```

##Link for Homework File
[https://github.com/lpgleason/2018Week7.git](https://github.com/lpgleason/2018Week7.git)